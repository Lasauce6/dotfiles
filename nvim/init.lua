  ...
  },
  {
    ...
    config = function()
      require('presence'):setup({
        ...
        show_time           = true,
        buttons             = true,                       -- Decide which presence buttons you want to display (see "Button customization")
        editing_text        = "Editing %s",               -- Format string rendered when an editable file is loaded in the buffer
        file_explorer_text  = "Browsing %s",              -- Format string rendered when browsing a file file_explorer_text
